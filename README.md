...
| [Python](https://www.python.org/)        | https://www.python.org/downloads/release/python-3810/  |
| [Django](https://www.djangoproject.com/) | https://www.djangoproject.com/download/                |

> **Note:** The application currently requires a Python version less than 3.9. The last available version with an installer is [3.8.10](https://www.python.org/downloads/release/python-3810/).
